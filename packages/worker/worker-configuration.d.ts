/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4da09b31a6f821375b2d53c21e687f47)
// Runtime types generated with workerd@1.20260120.0 2026-01-19 nodejs_als
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserSpace";
	}
	interface Env {
		DATABASE_URL: string;
		BETTER_AUTH_SECRET: string;
		BASE_URL: string;
		DISPOSABLE_SESSION_SECRET: string;
		X_API_KEY: string;
		X_API_SECRET: string;
		...
		USERSPACE: DurableObjectNamespace<import("./src/index").UserSpace>;
	}
}
